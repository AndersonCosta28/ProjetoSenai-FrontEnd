...
export default function App({ route, navigation }) {
  ...
  return (
    <View style={styles.container}>
      <Campo label='ID' editable ={false} defaultValue = {String(Evento.idevento)}></Campo>
      <Campo defaultValue={Evento.banda} label="Nome do evento: " onChangeText={Text => { setEvento(prevPreferences => { return { ...prevPreferences, banda: String(Text).trim() } }) }} />
      <View style={estilo.t}>
      ...
      <Campo defaultValue={Evento.valor_inteira} keyboardType="number-pad" label='Valor Inteira' onChangeText={Text => { setEvento(prevPreferences => { return { ...prevPreferences, valor_inteira: Text } }) }}></Campo>
      <Campo defaultValue={Evento.valor_meia} keyboardType="number-pad" label='Valor Meia' onChangeText={Text => { setEvento(prevPreferences => { return { ...prevPreferences, valor_meia: Text } }) }}></Campo>
